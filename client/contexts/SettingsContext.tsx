...
export const SettingsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    root.style.setProperty('--animation-speed-multiplier', speedMultipliers[settings.animationSpeed].toString());
  ...
  const updateSettings = (newSettings: Partial<GameSettings>) => {
    ...
    try {
      localStorage.setItem('memorymaster-settings', JSON.stringify(updatedSettings));
    } catch (error) {
